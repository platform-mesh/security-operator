...
func NewConfig() Config {
	...
	cfg.KCP.Kubeconfig = "/api-kubeconfig/kubeconfig"
	cfg.APIExportEndpointSliceName = "core.platform-mesh.io"
	cfg.BaseDomain = "portal.dev.local:8443"
	cfg.GroupClaim = "groups"
	cfg.UserClaim = "email"
	cfg.WorkspacePath = "root"
	cfg.WorkspaceTypeName = "security"
	cfg.HttpClientTimeoutSeconds = 30
	cfg.IDP.KubectlClientRedirectURLs = []string{"http://localhost:8000", "http://localhost:18000"}
	cfg.IDP.AccessTokenLifespan = 28800
	cfg.Invite.KeycloakClientID = "security-operator"
	cfg.Initializer.WorkspaceInitializerEnabled = true
	cfg.Initializer.IDPEnabled = true
	cfg.Initializer.InviteEnabled = true
	cfg.Initializer.WorkspaceAuthEnabled = true
	cfg.Webhooks.Port = 9443
	cfg.Webhooks.CertDir = "/tmp/k8s-webhook-server/serving-certs"
	return cfg
}
