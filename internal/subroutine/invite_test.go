...
func TestInviteSubroutine_Process_ClusterFromContextError(t *testing.T) {
	orgsClient := mocks.NewMockClient(t)
	mgr := mocks.NewMockManager(t)
	subroutine := NewInviteSubroutine(orgsClient, mgr)
...
func TestInviteSubroutine_Process_AccountGetError(t *testing.T) {
	orgsClient := mocks.NewMockClient(t)
	mgr := mocks.NewMockManager(t)
...
func TestInviteSubroutine_Process_MissingWorkspaceAnnotation(t *testing.T) {
	orgsClient := mocks.NewMockClient(t)
	mgr := mocks.NewMockManager(t)
	subroutine := NewInviteSubroutine(orgsClient, mgr)
...
func TestInviteSubroutine_Process_EmptyWorkspaceAnnotation(t *testing.T) {
	orgsClient := mocks.NewMockClient(t)
	mgr := mocks.NewMockManager(t)
	subroutine := NewInviteSubroutine(orgsClient, mgr)
