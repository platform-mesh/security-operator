...
import (
	...
	manager "sigs.k8s.io/multicluster-runtime/pkg/manager"
...
func (_m *MockManager) ClusterFromContext(ctx context.Context) (cluster.Cluster, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context) cluster.Cluster); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockManager_ClusterFromContext_Call) Return(_a0 cluster.Cluster, _a1 error) *MockManager_ClusterFromContext_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockManager_ClusterFromContext_Call) RunAndReturn(run func(context.Context) (cluster.Cluster, error)) *MockManager_ClusterFromContext_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *MockManager_Expecter) Engage(_a0 interface{}, _a1 interface{}, _a2 interface{}) *MockManager_Engage_Call {
	return &MockManager_Engage_Call{Call: _e.mock.On("Engage", _a0, _a1, _a2)}
}

func (_c *MockManager_Engage_Call) Run(run func(_a0 context.Context, _a1 string, _a2 cluster.Cluster)) *MockManager_Engage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(cluster.Cluster))
	})
	return _c
}

func (_c *MockManager_Engage_Call) Return(_a0 error) *MockManager_Engage_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockManager_Engage_Call) RunAndReturn(run func(context.Context, string, cluster.Cluster) error) *MockManager_Engage_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockManager_GetCluster_Call) Return(_a0 cluster.Cluster, _a1 error) *MockManager_GetCluster_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockManager_GetCluster_Call) RunAndReturn(run func(context.Context, string) (cluster.Cluster, error)) *MockManager_GetCluster_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockManager) GetLocalManager() pkgmanager.Manager {
	...
	var r0 pkgmanager.Manager
	if rf, ok := ret.Get(0).(func() pkgmanager.Manager); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(pkgmanager.Manager)
		}
	}
...
func (_c *MockManager_GetLocalManager_Call) Return(_a0 pkgmanager.Manager) *MockManager_GetLocalManager_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockManager_GetLocalManager_Call) RunAndReturn(run func() pkgmanager.Manager) *MockManager_GetLocalManager_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockManager) GetManager(ctx context.Context, clusterName string) (pkgmanager.Manager, error) {
	...
	var r0 pkgmanager.Manager
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (pkgmanager.Manager, error)); ok {
		return rf(ctx, clusterName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) pkgmanager.Manager); ok {
		r0 = rf(ctx, clusterName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(pkgmanager.Manager)
...
func (_c *MockManager_GetManager_Call) Return(_a0 pkgmanager.Manager, _a1 error) *MockManager_GetManager_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockManager_GetManager_Call) RunAndReturn(run func(context.Context, string) (pkgmanager.Manager, error)) *MockManager_GetManager_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockManager) GetProvider() multicluster.Provider {
	...
	if rf, ok := ret.Get(0).(func() multicluster.Provider); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockManager_GetProvider_Call) Return(_a0 multicluster.Provider) *MockManager_GetProvider_Call {
	_c.Call.Return(_a0)
	return _c
}
